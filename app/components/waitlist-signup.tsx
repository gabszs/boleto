      ...
      <div className="flex-1 flex flex-col justify-center items-center text-center">
        <div>
          <h2 className="text-4xl sm:text-5xl font-extrabold mb-4 bg-clip-text text-transparent bg-gradient-to-br from-gray-200 to-gray-600">
            Acelere Seus Pagamentos com a boleto.dev
          </h2>
        </div>
        <div>
          <p className="text-lg sm:text-xl mb-8 text-gray-300">
            Uma solução simples e poderosa, criada para desenvolvedores. Cadastre-se agora e experimente nosso gateway
            de boletos com integração fácil via API!
          </p>
        </div>
        ...
        <div>
          <div className="flex items-center justify-center mt-8">
            ...
            <p className="text-white font-semibold">{waitlistCount}+ pessoas na lista de espera</p>
          </div>
        </div>
      </div>
